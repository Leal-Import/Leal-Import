...
const createPaymentRow = ({
    ...
    method.textContent = payment.paymentMethod;
    ...
    if (!isView) {
        ...
        paymentUpActions.classList.add('paymentUpActions');
        const btnDelete = document.createElement('button');
        btnDelete.type = 'button';
        btnDelete.classList.add('btnTrash');
        ...
        btnEdit.addEventListener('click', () => onEditPayment(payments, index, paymentItem));
