...
export const initSparePartDetailEvents = ({ Refs, onSubmit, onCalculateTotal, onOpenModal, onSaveDataModal, onValidateUrl }) => {
    ...
    txtCosts.forEach(txt => txt.addEventListener("input", onCalculateTotal));
};
